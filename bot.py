...
BOT_TOKEN = "8737096321:AAFwCWXI1NHqSspXMZI0OqoxAs60JDf0ihc" # <-- ВСТАВЬ СВОЙ ТОКЕН
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            for page_num in range(40):
                ...
                # Отправляем апдейт в чат каждые 5 страниц, чтобы было видно, что бот не умер
    ...
    if apartments == "empty" or not apartments:
        ...
        for apt in apartments:
            try:
                ...
                pass # Игнорируем ошибки отправки отдельных сообщений
...
if __name__ == "__main__":
    asyncio.run(main())                await page.wait_for_selector('[data-testid="property-card"]', timeout=15000)
            except:
                return "empty"
